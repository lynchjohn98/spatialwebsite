...
export default function StudentModulePage() {
  ...
  const MODULE_CONFIG = {
    ...
    shortTitle: "Orthographic Projection", // For the navbar

    // Learning content
    learningIntention: "Today, we are learning how to create a set of orthographic drawings from a single object.",
    learningOutcomes: [
    ...
    introVideoUrl: "",
    miniLectureUrl: "https://vimeopro.com/sorby/spatial3atyhzoh7ta/video/175886752",
    gettingStartedVideos: [
      { url: "https://vimeopro.com/sorby/spatial3atyhzoh7ta/video/170976907", title: "Video 1" },
      { url: "https://vimeopro.com/sorby/spatial3atyhzoh7ta/video/177460037", title: "Video 2" }
    ],
    interactiveSoftwareUrl: "https://www.higheredservices.org/HES01/Module_4/module_4_theme_1.html"
  };
  // ====================================================================
              ...
              <div className="space-y-6 lg:space-y-8">
                ...
                <section className="bg-gray-800/70 rounded-xl p-6 sm:p-8 shadow-lg border border-gray-700/50">
                  ...
                  <div className="space-y-4">
                    <div className="bg-gray-700/30 p-6 rounded-lg">
                      <button
                        onClick={() => router.push(`/student/student-dashboard/quizzes/12`)}
