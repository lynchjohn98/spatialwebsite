...
export default function FlatPatternsQuiz() {
    ...
    try {
      ...
      if (sessionStorage.getItem("courseData") !== null) {
        ...
        if (courseData?.settings?.quiz_settings) {
          const flatPatternsQuiz = courseData.settings.quiz_settings.find(
            quiz => quiz.name === "Flat Patterns"
          );

          if (flatPatternsQuiz) {
            // Check visibility
            if (flatPatternsQuiz.visibility === "Yes") {
              setQuizVisible(true);
              setIsLoading(false);
            } else {
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-3">
                  <div 
                    ...
                    onClick={() => handleImageClick("/quiz_images/flat_patterns/question10.png", "Flat Patterns Example 1")}
                  >
                    <img
                      src="/quiz_images/flat_patterns/question10.png"
                      alt="Flat Patterns Example 1"
                  ...
                  Select the object that results by folding up the pattern shown on the left below.   </p>
                  </div>
