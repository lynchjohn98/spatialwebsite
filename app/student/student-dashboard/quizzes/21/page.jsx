...
import { quizData } from "../../../../../app/library/quiz_data/post_intervention_survey";
import { submitStudentSurvey } from "../../../../library/services/student_services/student_quiz";

export default function PostInterventionSurvey() {
            ...
            <div className="mb-8 sm:mb-12">
              ...
              <div className="bg-gray-800/70 rounded-xl p-6 sm:p-8 shadow-lg border border-gray-700/50">
                <p className="text-lg text-gray-300 leading-relaxed">
                  This survey contains statements asking about your experience in the spatial thinking course.
                  Please answer each question honestly and to the best of your abilities. Additional comments can be provided at the very end of the survey. 
