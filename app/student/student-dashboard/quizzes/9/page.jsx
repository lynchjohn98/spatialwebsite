...
import { quizData } from "../../../../library/quiz_data/object_reflections_symmetry_quiz";
import { submitStudentQuiz } from "../../../../library/services/student_services/student_quiz";

export default function ReflectionsSymmetryQuiz() {
  ...
  useEffect(() => {
    try {
      ...
      if (sessionStorage.getItem("courseData") !== null) {
        ...
        // Check if quiz settings exist and find the "Reflections and Symmetry" quiz
        if (courseData?.settings?.quiz_settings) {
          const reflectionsSymmetryQuiz = courseData.settings.quiz_settings.find(
            quiz => quiz.name === "Reflections and Symmetry"
          );

          if (reflectionsSymmetryQuiz) {
            // Check visibility
            if (reflectionsSymmetryQuiz.visibility === "Yes") {
              setQuizVisible(true);
              setIsLoading(false);
            } else {
               ...
               {/* Example 1 */}
                <div className="space-y-3">
                  <div 
                    ...
                    onClick={() => handleImageClick("/quiz_images/object_reflections_symmetry/question1.png", "Reflection and Symmetry Example 1")}
                  >
                    <img
                      src="/quiz_images/object_reflections_symmetry/question1.png"
                      alt="Reflection and Symmetry Example 1"
                  ...
                  <div className="bg-gray-700/30 rounded-lg p-4">
                    <p className="text-gray-200 font-medium">
                      Select the number of planes of symmetry the object has. (Don't forget planes on the diagonal.)
                    </p>
                  </div>
                    ...
                    {!showAnswer1 ? (
                      ...
                      <div className="bg-green-600/20 border border-green-600/50 p-3 rounded-lg">
                        <p className="text-green-300 text-left">
                          <span className="font-semibold">Answer:</span> 2 Planes of Symmetry
                        </p>
                      </div>
                    )}
                  </button>
