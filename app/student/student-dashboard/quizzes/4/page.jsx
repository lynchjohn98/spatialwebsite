...
export default function Module1Quiz() {
  ...
  useEffect(() => {
    try {
      ...
      console.error("Error parsing student data from sessionStorage:", error);
    }
    console.log("Inside of the quiz page.", studentData);
  }, []);

  const handleQuizComplete = async (results) => {
    console.log("Quiz completed with results:", results);
    console.log("Student data currently working on:", studentData);
    try {
      const payload = {
