...
export default function MathInstrumentPostTest() {
  ...
  useEffect(() => {
    try {
      ...
      if (quizSettings) {
        ...
        console.log("Math Instrument Post-Test found:", mathInstrumentPostTest);

        if (mathInstrumentPostTest) {
          // Check visibility
          if (mathInstrumentPostTest.visibility === "Yes") {
            setQuizVisible(true);
            setIsLoading(false);
          } else {
