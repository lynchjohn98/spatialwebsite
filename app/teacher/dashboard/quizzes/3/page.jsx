              ...
              <div className="space-y-6">
                <div className="bg-blue-600/10 border border-blue-600/30 rounded-lg p-4">
                  <p className="text-gray-200 leading-relaxed">
                   The following test will contain 8 mathematical questions. Please click the button below when you are ready to begin. Leaving the page or closing the browser will automatically submit the quiz.
                  </p>
                </div>
