...
export default function TeacherModulePage() {
  ...
  const MODULE_CONFIG = {
    number: 10,
    title:  "Inclined and Curved Surfaces",
    shortTitle: "Inclined and Curved Surfaces", // For the navbar

    // Learning content
    learningIntention: "Today, we are learning how to create a set of orthographic drawings from an object that includes inclined or curved surfaces.",
    learningOutcomes: [
      ...
      "Sketch the top, front, and side views (properly aligned) from a given isometric view of an object that includes inclined or curved surfaces, including hidden lines when necessary.",
      "Sketch an isometric view of an object with inclined surfaces, given its top, front, and side views."
    ],
    ...
    introVideoUrl: "",
    miniLectureUrl: "https://vimeopro.com/sorby/spatial3atyhzoh7ta/video/174513397",
    gettingStartedVideos: [
      { url: "https://vimeopro.com/sorby/spatial3atyhzoh7ta/video/178667573", title: "Video 1" },
      { url: "https://vimeopro.com/sorby/spatial3atyhzoh7ta/video/171030416", title: "Video 2" },
      { url: "https://vimeopro.com/sorby/spatial3atyhzoh7ta/video/172113629", title: "Video 3" }
    ],
    interactiveSoftwareUrl: "https://www.higheredservices.org/HES01/Module_5/module_5_theme_1.html"
  };
  // ====================================================================
          ...
          <div className="space-y-6 lg:space-y-8">
            ...
            <section className="bg-gray-800/70 rounded-xl p-6 sm:p-8 shadow-lg border border-gray-700/50">
              ...
              <div className="space-y-4">
                <div className="bg-gray-700/30 p-6 rounded-lg">
                  <button
                    onClick={() => router.push("/teacher/training/module10/quiz")}
